...
export default function Sidebar({ stage }: { stage: ImportStage }) {
  return (
    <aside className="hidden w-64 shrink-0 flex-col bg-graphite-900 lg:sticky lg:top-0 lg:flex lg:h-screen">
      <div className="flex h-full min-h-0 flex-col gap-6 px-5 py-6">
        {/* Logo */}
        <div className="flex min-w-0 items-center gap-3 px-1">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl bg-teal-500 font-display text-base font-bold text-graphite-900">
            <p className="font-display text-xl font-semibold leading-tight text-black">
              G
            </p>
          </div>
